...
public class ExamController 
{
	...
	@GetMapping("/searchResults/{courseName}/{enrollid}")
	public ResponseEntity<List<Exam>> getResultsByCourseName(@PathVariable String courseName, @PathVariable int enrollid) throws Throwable
	{
		ResponseEntity re =  new ResponseEntity(studentexamservice.searchResultsByCourseName(courseName, enrollid), HttpStatus.OK);
		return re;
	}
